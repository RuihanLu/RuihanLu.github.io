#!/usr/bin/env python3
"""
Create T-shirt back design with actual sponsor logos - Final Design Version
"""
...
def create_tshirt_back_design():
    """Create T-shirt back design with actual sponsor logos - clean circular design"""
    ...
    # Creative layout with different sizes and positions - no color backgrounds
    logo_positions = [
        # Gold Sponsors - Large circular containers
        ("logo-anu.png", 150, 150, 140, 140),      # Top left
        ("logo_google.png", 400, 120, 140, 140),   # Top center
        ("monash-logo-mono.svg", 650, 150, 140, 140), # Top right
        ("pioneer.png", 200, 320, 140, 140),       # Middle left
        ("yepai.png", 450, 300, 140, 140),         # Middle center
        ("CSIRO_Logo.png", 600, 320, 140, 140),    # Middle right
        
        # Silver Sponsors - Medium circular containers
        ("dairnet-logo.png", 100, 500, 100, 100), # Bottom left
        ("Fomelogo.png", 350, 480, 100, 100),     # Bottom center
        ("core.png", 550, 500, 100, 100),          # Bottom right
        
        # Bronze Sponsors - Small circular containers
        ("unsw_ai.png", 250, 580, 80, 80),        # Very bottom left
        ("springer-logo.png", 450, 580, 80, 80),   # Very bottom right
    ]
    ...
    for logo_file, x, y, w, h in logo_positions:
        ...
        if os.path.exists(logo_path):
            try:
                ...
                # Create white circle container with subtle border
                container = Image.new('RGBA', (w, h), (255, 255, 255, 0))
                container_draw = ImageDraw.Draw(container)
                container_draw.ellipse([0, 0, w-1, h-1], fill='white', outline='#e0e0e0', width=1)
                ...
                draw.ellipse([x, y, x+w, y+h], fill='#f8f8f8', outline='#e0e0e0', width=1)
    ...
    # Save the image
    output_path = "imgs/tshirt-back-with-logos-final.png"
